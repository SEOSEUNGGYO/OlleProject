...
public class EvaluationDAO {
	...
	public void evaluationDelete(String evaluation_user, String evaluation_course) {	
		String SQL = "DELETE FROM evaluation where evaluation_user=? and evaluation_course=?";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try {
