...
public class AccompanyDAO {
	...
	public ArrayList<AccompanyDTO> getUserAccompanyList(String accompany_host,int accompany_year, int accompany_month, int accompany_date){
		ArrayList<AccompanyDTO> list = new ArrayList<AccompanyDTO>();
		String SQL = "SELECT * FROM accompany where accompany_host=? and (accompany_year>? or accompany_month>? or(accompany_year=? and accompany_month=? and accompany_date>=?)) order by accompany_year desc, accompany_month desc, accompany_date desc";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try {
	...
	public int accompanyUpdate(AccompanyDTO accompanyDTO,int accompany_year_hidden, int accompany_month_hidden, int accompany_date_hidden) {
		...
		try {
			...
			pstmt.setInt(9, accompany_year_hidden);
			pstmt.setInt(10, accompany_month_hidden);
			pstmt.setInt(11, accompany_date_hidden);
