...
ArrayList<AccompanyDTO> getUserAccompanyList = accompanyDAO.getUserAccompanyList(user_id,cal.get(Calendar.YEAR),cal.get(Calendar.MONTH)+1,cal.get(Calendar.DATE));
      								...
      								<form action="accompanyUpdateAction.jsp" method="post">
										<table class="table table-bordered" style="text-align: center; vertical-align: middle;" >
											...
											<tr height="50">
												...
												<input type="hidden" name="accompany_year_hidden" value="<%=accompanyDTO.getAccompany_year() %>">
												<input type="hidden" name="accompany_month_hidden" value="<%=accompanyDTO.getAccompany_month() %>">	
												<input type="hidden" name="accompany_date_hidden" value="<%=accompanyDTO.getAccompany_date() %>">					
