...
<%
	...
	int accompany_year_hidden =  Integer.parseInt(request.getParameter("accompany_year_hidden"));
	int accompany_month_hidden =  Integer.parseInt(request.getParameter("accompany_month_hidden"));
	int accompany_date_hidden =  Integer.parseInt(request.getParameter("accompany_date_hidden"));
	...
	int result = accompanyDAO.accompanyUpdate(accompanyDTO,accompany_year_hidden,accompany_month_hidden,accompany_date_hidden);
